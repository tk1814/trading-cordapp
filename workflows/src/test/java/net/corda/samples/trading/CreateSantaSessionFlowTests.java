...
import net.corda.samples.trading.contracts.SantaSessionContract;
import net.corda.samples.trading.flows.CreateSantaSessionFlow;
...
public class CreateSantaSessionFlowTests {
    ...
    public void setup() {
        ...
        network = new MockNetwork(new MockNetworkParameters().withCordappsForAllNodes(ImmutableList.of(
                ...
                TestCordapp.findCordapp("net.corda.samples.trading.flows"))).withNetworkParameters(testNetworkParameters)
    ...
    public void transactionConstructedHasOneOutputUsingTheCorrectContract() throws Exception {
        ...
        assertEquals("net.corda.samples.trading.contracts.SantaSessionContract", output.getContract());
    }
