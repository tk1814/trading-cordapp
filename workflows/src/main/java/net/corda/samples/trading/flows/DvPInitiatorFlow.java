...
public interface DvPInitiatorFlow {
    ...
    class SellStock extends FlowLogic<String> {
        ...
        public String call() throws FlowException {
            ...
            // To get the transferring stock, we get the StockState from the vault and get its pointer
             ...
             StateAndRef<FungibleStockState> stockTokenTypeInfo = stockPointer.getPointer().resolve(getServiceHub());
            ...
            //send the proof to stocks
             QueryCriteria tokenCriteria = QueryUtilities.heldTokenAmountCriteria(stockPointer, getOurIdentity());
             List<StateAndRef<FungibleToken>> heldStockTokens = getServiceHub().getVaultService().
    ...
    class BuyStock extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            if (!currencyTokenType.getTokenIdentifier().equals("USD")) {
                throw new FlowException("The currency" + currencyTokenType.getTokenIdentifier() + "is not we expected");
            }
            ...
            final SecureHash signedTxId = subFlow(new SignTransactionFlow(sellerSession) {
                ...
                protected void checkTransaction(@NotNull SignedTransaction stx) throws FlowException {
                    ...
                    if (outputHeldStock.getAmount().getQuantity() != buyerTradeState.getStockQuantity()) {
                        throw new FlowException("The quantity of the sotck is not we expected");
                    }
